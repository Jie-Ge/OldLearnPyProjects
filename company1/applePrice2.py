...
data = pd.read_excel("applePrice1.xlsx")
...
newdata = pd.get_dummies(data[['name', 'province']], sparse=True)
# pca = PCA(n_components=2)
# newdata = pca.fit_transform(newdata)
# invx = pca.inverse_transform(newdata)
