...
SelectorKey = namedtuple('SelectorKey', ['fileobj', 'fd', 'events', 'data_of_visual'])
...
class BaseSelector(object):
    ...
    def modify(self, fileobj, events, data=None):
        """ Change a registered file object monitored events and data_of_visual. """
        ...
        if events != key.events:
            ...
            # Use a shortcut to update the data_of_visual.
