...
console.log("data[000]: " + typeof(Object.keys(patent_obj)));
...
let option = {
    ...
    series: serie_func(patent_cla, patent_obj)
};

/*serie生成器*/
function serie_func(patent_class, patent_object){  
