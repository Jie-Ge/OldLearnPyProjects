...
'''训练集'''
train_auth_info = pd.read_csv('./train_auth_info.csv', low_memory=False)
train_bankcard_info = pd.read_csv('./train_bankcard_info.csv', low_memory=False)
train_credit_info = pd.read_csv('./train_credit_info.csv', low_memory=False)
train_order_info = pd.read_csv('./train_order_info.csv', low_memory=False)
# train_recieve_addr_info = pd.read_csv('./train_recieve_addr_info.csv', low_memory=False)
# train_user_info = pd.read_csv('./train_user_info.csv', low_memory=False)
train_target = pd.read_csv('./train_target.csv', low_memory=False)

with open('./train_recieve_addr_info.csv', 'r') as f:
    train_recieve_addr_info = f.readline()
with open('./train_user_info.csv', 'r') as f:
    train_user_info = f.readline()

# '''测试集'''
test_auth_info = pd.read_csv('./test_auth_info.csv', low_memory=False)
test_bankcard_info = pd.read_csv('./test_bankcard_info.csv', low_memory=False)
test_credit_info = pd.read_csv('./test_credit_info.csv', low_memory=False)

with open('./test_order_info.csv', 'r') as f:
    test_order_info = f.readline()
with open('./test_recieve_addr_info.csv', 'r') as f:
    test_recieve_addr_info = f.readline()
with open('./test_user_info.csv', 'r') as f:
    test_user_info = f.readline()
